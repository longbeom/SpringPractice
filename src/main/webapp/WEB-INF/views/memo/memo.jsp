	...
	<table class="table">
		...
		<c:forEach items="${memoList}" var="memo" varStatus="vs">
			<tr>
				...
				<!-- 삭제 버튼 -->
				<td>
					<button type="button" class="btn btn-outline-success" onclick="fn_deleteMemo(${memo.MEMONO});">삭제</button>
				</td>	
			</tr>
		</c:forEach>
	</table>
...
<script>
	function fn_deleteMemo(no) {
		location.href="${path}/memo/deleteMemo.do?no="+no;
	}	
</script>
